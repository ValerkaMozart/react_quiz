...
export function fetchQuizes() {
    return async dispatch => {
        ...
        try {
            let response = await axios.get('https://react-quiz-f1053-default-rtdb.firebaseio.com/quizes.json')
...
export function fetchQuizById(quizId) {
    return async dispatch => {
        dispatch(fetchQuizesStart())
        try {
            let response = await axios.get(`https://react-quiz-f1053-default-rtdb.firebaseio.com/quizes/${quizId}.json`)
